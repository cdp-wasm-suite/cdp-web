...
//
// The app imports the engine via the bare specifier "cdp-wasm",
// resolved by the import map in index.html to ./node_modules/cdp-wasm/
// (installed from npm). The server root is this directory, so the app
