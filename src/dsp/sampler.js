...
// AudioWorklet (the same code the C++ plugin uses — see @cdp-wasm-suite/cdp-sampler).
...
import { wavToAudioBuffer } from 'cdp-wasm/wav';
...
const WASM_URL = './node_modules/@cdp-wasm-suite/cdp-sampler/wasm/cdp-sampler.wasm';
